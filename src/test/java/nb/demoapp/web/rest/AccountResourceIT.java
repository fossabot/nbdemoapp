package nb.demoapp.web.rest;

import static nb.demoapp.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import nb.demoapp.IntegrationTest;
import nb.demoapp.config.Constants;
import nb.demoapp.domain.User;
import nb.demoapp.repository.AuthorityRepository;
import nb.demoapp.repository.UserRepository;
import nb.demoapp.security.AuthoritiesConstants;
import nb.demoapp.service.UserService;
import nb.demoapp.service.dto.AdminUserDTO;
import nb.demoapp.service.dto.PasswordChangeDTO;
import nb.demoapp.service.dto.UserDTO;
import nb.demoapp.web.rest.vm.KeyAndPasswordVM;
import nb.demoapp.web.rest.vm.ManagedUserVM;
